...
public class ScopeCommand extends BaseCommand {
    ...
    @HelpCommand
    @CommandPermission("mithril.command.scope|mithril.command.scope.help")
    @Syntax("[page]")
    ...
    @Subcommand("retrieve")
    @CommandPermission("mithril.command.scope|mithril.command.scope.retrieve")
    @Description("Retrieve all scopes")
    public static void onRetrieve(CommandSender sender) {
        List<String> scopes = Mithril.getInstance().getScopeManager().retrieve()
                .stream()
    ...
    @Subcommand("create")
    @CommandPermission("mithril.command.scope|mithril.command.scope.create")
    @Syntax("<name>")
    ...
    @CommandPermission("mithril.command.scope|mithril.command.scope.add")
    ...
    public static void onAdd(CommandSender sender, Scope scope, Instance instance) {
        ...
        Mithril.getInstance().getScopeManager().add(scope, instance.getName());
    ...
    @Subcommand("remove")
    @CommandCompletion("@scopes @instances")
    @CommandPermission("mithril.command.scope|mithril.command.scope.remove")
    @Syntax("<scope> <instance>")
    ...
    public static void onRemove(CommandSender sender, Scope scope, Instance instance) {
        ...
        Mithril.getInstance().getScopeManager().remove(scope, instance.getName());
